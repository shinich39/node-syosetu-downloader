...
var cookieJar = new import_tough_cookie.CookieJar();
cookieJar.setCookieSync("over18=yes", "https://novel18.syosetu.com/");
cookieJar.setCookieSync("over18=off", "https://syosetu.org/");
var fetchWithCookies = (0, import_fetch_cookie.default)(fetch, cookieJar);
...
var Alphapolis = class extends Web {
  ...
  async getMetadata(uid, nid) {
    ...
    const updatedAt = updatedAtStr.length === 12 ? (0, import_dayjs.default)(updatedAtStr, "YYYYMMDDHHmm").valueOf() : 0;
    const chapterIds = [];
...
var Hameln = class extends Web {
  ...
  async getMetadata(id) {
    ...
    const createdAt = createdAtStr.length === 12 ? (0, import_dayjs2.default)(createdAtStr, "YYYYMMDDHHmm").valueOf() : 0;
    const updatedAt = updatedAtStr.length === 12 ? (0, import_dayjs2.default)(updatedAtStr, "YYYYMMDDHHmm").valueOf() : 0;
    const chapterIds = [];
  ...
  async getMetadata(id) {
    ...
    for (const obj of Object.values(
      ...
      if (obj.__typename === "Episode") {
        const publishedAt = (0, import_dayjs3.default)(obj.publishedAt).valueOf();
        if (!createdAt) {
...
// src/utils/url.ts
function createURL(provider, bookId, chapterId) {
  let url = "";
  if (provider === "narou") {
